...
public class AnalysisResult {
    ...
    public enum PatientType {
        ...
        public static PatientType getName(String value) {
            for (PatientType val : values()) {
                if (val.getName().equalsIgnoreCase(value)) {
                    return val;
                }
            }

            return VIOLATED; // This shouldn't happen but just return violated...
        }
    }
